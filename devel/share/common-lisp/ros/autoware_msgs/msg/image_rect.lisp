...
(cl:defmethod cl:initialize-instance :after ((m <image_rect>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'image_rect)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<image_rect> is deprecated: use autoware_msgs-msg:image_rect instead.")))
