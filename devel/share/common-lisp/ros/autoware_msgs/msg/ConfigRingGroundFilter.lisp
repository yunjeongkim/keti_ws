...
(cl:defmethod cl:initialize-instance :after ((m <ConfigRingGroundFilter>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigRingGroundFilter)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigRingGroundFilter> is deprecated: use autoware_msgs-msg:ConfigRingGroundFilter instead.")))

(cl:ensure-generic-function 'sensor_model-val :lambda-list '(m))
(cl:defmethod sensor_model-val ((m <ConfigRingGroundFilter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:sensor_model-val is deprecated.  Use autoware_msgs-msg:sensor_model instead.")
  (sensor_model m))
...
(cl:defmethod max_slope-val ((m <ConfigRingGroundFilter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:max_slope-val is deprecated.  Use autoware_msgs-msg:max_slope instead.")
  (max_slope m))

(cl:ensure-generic-function 'vertical_thres-val :lambda-list '(m))
(cl:defmethod vertical_thres-val ((m <ConfigRingGroundFilter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:vertical_thres-val is deprecated.  Use autoware_msgs-msg:vertical_thres instead.")
  (vertical_thres m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigRingGroundFilter>)))
  ...
  "autoware_msgs/ConfigRingGroundFilter")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigRingGroundFilter)))
  "Returns string type for a message object of type 'ConfigRingGroundFilter"
  "autoware_msgs/ConfigRingGroundFilter")
