...
(cl:defmethod cl:initialize-instance :after ((m <ConfigRingFilter>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigRingFilter)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigRingFilter> is deprecated: use autoware_msgs-msg:ConfigRingFilter instead.")))

(cl:ensure-generic-function 'ring_div-val :lambda-list '(m))
(cl:defmethod ring_div-val ((m <ConfigRingFilter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:ring_div-val is deprecated.  Use autoware_msgs-msg:ring_div instead.")
  (ring_div m))

(cl:ensure-generic-function 'voxel_leaf_size-val :lambda-list '(m))
(cl:defmethod voxel_leaf_size-val ((m <ConfigRingFilter>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:voxel_leaf_size-val is deprecated.  Use autoware_msgs-msg:voxel_leaf_size instead.")
  (voxel_leaf_size m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigRingFilter>)))
  ...
  "autoware_msgs/ConfigRingFilter")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigRingFilter)))
  "Returns string type for a message object of type 'ConfigRingFilter"
  "autoware_msgs/ConfigRingFilter")
