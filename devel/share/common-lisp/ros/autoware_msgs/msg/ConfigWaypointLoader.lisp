...
(cl:defmethod cl:initialize-instance :after ((m <ConfigWaypointLoader>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigWaypointLoader)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigWaypointLoader> is deprecated: use autoware_msgs-msg:ConfigWaypointLoader instead.")))

(cl:ensure-generic-function 'multi_lane_csv-val :lambda-list '(m))
(cl:defmethod multi_lane_csv-val ((m <ConfigWaypointLoader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:multi_lane_csv-val is deprecated.  Use autoware_msgs-msg:multi_lane_csv instead.")
  (multi_lane_csv m))

(cl:ensure-generic-function 'replanning_mode-val :lambda-list '(m))
(cl:defmethod replanning_mode-val ((m <ConfigWaypointLoader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:replanning_mode-val is deprecated.  Use autoware_msgs-msg:replanning_mode instead.")
  (replanning_mode m))

(cl:ensure-generic-function 'velocity_max-val :lambda-list '(m))
(cl:defmethod velocity_max-val ((m <ConfigWaypointLoader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:velocity_max-val is deprecated.  Use autoware_msgs-msg:velocity_max instead.")
  (velocity_max m))

(cl:ensure-generic-function 'velocity_min-val :lambda-list '(m))
(cl:defmethod velocity_min-val ((m <ConfigWaypointLoader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:velocity_min-val is deprecated.  Use autoware_msgs-msg:velocity_min instead.")
  (velocity_min m))

(cl:ensure-generic-function 'accel_limit-val :lambda-list '(m))
(cl:defmethod accel_limit-val ((m <ConfigWaypointLoader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:accel_limit-val is deprecated.  Use autoware_msgs-msg:accel_limit instead.")
  (accel_limit m))

(cl:ensure-generic-function 'decel_limit-val :lambda-list '(m))
(cl:defmethod decel_limit-val ((m <ConfigWaypointLoader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:decel_limit-val is deprecated.  Use autoware_msgs-msg:decel_limit instead.")
  (decel_limit m))

(cl:ensure-generic-function 'radius_thresh-val :lambda-list '(m))
(cl:defmethod radius_thresh-val ((m <ConfigWaypointLoader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:radius_thresh-val is deprecated.  Use autoware_msgs-msg:radius_thresh instead.")
  (radius_thresh m))

(cl:ensure-generic-function 'radius_min-val :lambda-list '(m))
(cl:defmethod radius_min-val ((m <ConfigWaypointLoader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:radius_min-val is deprecated.  Use autoware_msgs-msg:radius_min instead.")
  (radius_min m))

(cl:ensure-generic-function 'resample_mode-val :lambda-list '(m))
(cl:defmethod resample_mode-val ((m <ConfigWaypointLoader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:resample_mode-val is deprecated.  Use autoware_msgs-msg:resample_mode instead.")
  (resample_mode m))

(cl:ensure-generic-function 'resample_interval-val :lambda-list '(m))
(cl:defmethod resample_interval-val ((m <ConfigWaypointLoader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:resample_interval-val is deprecated.  Use autoware_msgs-msg:resample_interval instead.")
  (resample_interval m))

(cl:ensure-generic-function 'velocity_offset-val :lambda-list '(m))
(cl:defmethod velocity_offset-val ((m <ConfigWaypointLoader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:velocity_offset-val is deprecated.  Use autoware_msgs-msg:velocity_offset instead.")
  (velocity_offset m))

(cl:ensure-generic-function 'end_point_offset-val :lambda-list '(m))
(cl:defmethod end_point_offset-val ((m <ConfigWaypointLoader>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:end_point_offset-val is deprecated.  Use autoware_msgs-msg:end_point_offset instead.")
  (end_point_offset m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigWaypointLoader>)))
  ...
  "autoware_msgs/ConfigWaypointLoader")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigWaypointLoader)))
  "Returns string type for a message object of type 'ConfigWaypointLoader"
  "autoware_msgs/ConfigWaypointLoader")
