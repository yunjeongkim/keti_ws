...
(cl:defclass <image_rect_ranged> (roslisp-msg-protocol:ros-message)
  ((rect
    :reader rect
    :initarg :rect
    :type autoware_msgs-msg:image_rect
    :initform (cl:make-instance 'autoware_msgs-msg:image_rect))
   (range
    :reader range
    :initarg :range
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <image_rect_ranged>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'image_rect_ranged)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<image_rect_ranged> is deprecated: use autoware_msgs-msg:image_rect_ranged instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<image_rect_ranged>)))
  ...
  "autoware_msgs/image_rect_ranged")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'image_rect_ranged)))
  "Returns string type for a message object of type 'image_rect_ranged"
  "autoware_msgs/image_rect_ranged")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<image_rect_ranged>)))
  ...
  (cl:format cl:nil "image_rect rect~%float32 range~%float32 min_height~%float32 max_height~%~%================================================================================~%MSG: autoware_msgs/image_rect~%int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'image_rect_ranged)))
  "Returns full string definition for message of type 'image_rect_ranged"
  (cl:format cl:nil "image_rect rect~%float32 range~%float32 min_height~%float32 max_height~%~%================================================================================~%MSG: autoware_msgs/image_rect~%int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%~%~%"))
