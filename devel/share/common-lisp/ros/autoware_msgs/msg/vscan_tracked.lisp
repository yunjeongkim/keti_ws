...
(cl:defclass <vscan_tracked> (roslisp-msg-protocol:ros-message)
  ((position
   ...
   (geo_rect
    :reader geo_rect
    :initarg :geo_rect
    :type autoware_msgs-msg:geometric_rectangle
    :initform (cl:make-instance 'autoware_msgs-msg:geometric_rectangle)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <vscan_tracked>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'vscan_tracked)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<vscan_tracked> is deprecated: use autoware_msgs-msg:vscan_tracked instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<vscan_tracked>)))
  ...
  (cl:format cl:nil "geometry_msgs/Point position~%float32 orientation~%float32 velocity~%geometric_rectangle geo_rect~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: autoware_msgs/geometric_rectangle~%float32 wl~%float32 wr~%float32 lf~%float32 lb~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'vscan_tracked)))
  "Returns full string definition for message of type 'vscan_tracked"
  (cl:format cl:nil "geometry_msgs/Point position~%float32 orientation~%float32 velocity~%geometric_rectangle geo_rect~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: autoware_msgs/geometric_rectangle~%float32 wl~%float32 wr~%float32 lf~%float32 lb~%~%"))
