...
class image_rect_ranged {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = image_rect.serialize(obj.rect, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new image_rect_ranged(null);
    // Deserialize message field [rect]
    data.rect = image_rect.deserialize(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new image_rect_ranged(null);
    if (msg.rect !== undefined) {
      resolved.rect = image_rect.Resolve(msg.rect)
    }
    else {
      resolved.rect = new image_rect()
    }
...
module.exports = image_rect_ranged;
