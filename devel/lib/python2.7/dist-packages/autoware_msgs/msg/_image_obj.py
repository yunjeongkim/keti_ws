...
"""autogenerated by genpy from autoware_msgs/image_obj.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','autoware_msgs/image_rect[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = autoware_msgs.msg.image_rect()
        _x = val1
        start = end
        end += 20
