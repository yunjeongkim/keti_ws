...
"""autogenerated by genpy from autoware_msgs/vscan_tracked_array.msg. Do not edit."""
import sys
...
class vscan_tracked_array(genpy.Message):
  ...
  _type = "autoware_msgs/vscan_tracked_array"
...
float32 lb"""
  ...
  _slot_types = ['std_msgs/Header','autoware_msgs/vscan_tracked[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = autoware_msgs.msg.vscan_tracked()
        _v3 = val1.position
        _x = _v3
        start = end
        end += 24
