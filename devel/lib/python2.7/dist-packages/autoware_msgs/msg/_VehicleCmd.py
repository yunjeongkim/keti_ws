...
"""
  ...
  _slot_types = ['std_msgs/Header','autoware_msgs/steer_cmd','autoware_msgs/accel_cmd','autoware_msgs/brake_cmd','autoware_msgs/lamp_cmd','int32','int32','geometry_msgs/TwistStamped','autoware_msgs/ControlCommand','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.steer_cmd is None:
        self.steer_cmd = autoware_msgs.msg.steer_cmd()
      if self.accel_cmd is None:
        self.accel_cmd = autoware_msgs.msg.accel_cmd()
      if self.brake_cmd is None:
        self.brake_cmd = autoware_msgs.msg.brake_cmd()
      if self.lamp_cmd is None:
        self.lamp_cmd = autoware_msgs.msg.lamp_cmd()
