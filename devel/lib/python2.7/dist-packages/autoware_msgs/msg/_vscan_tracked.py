...
"""autogenerated by genpy from autoware_msgs/vscan_tracked.msg. Do not edit."""
import sys
...
class vscan_tracked(genpy.Message):
  ...
  _type = "autoware_msgs/vscan_tracked"
...
float32 lb"""
  ...
  _slot_types = ['geometry_msgs/Point','float32','float32','autoware_msgs/geometric_rectangle']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.geo_rect is None:
        self.geo_rect = autoware_msgs.msg.geometric_rectangle()
    else:
      self.position = geometry_msgs.msg.Point()
      self.orientation = 0.
      self.velocity = 0.
