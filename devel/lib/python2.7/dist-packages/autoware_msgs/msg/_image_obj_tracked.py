...
"""autogenerated by genpy from autoware_msgs/image_obj_tracked.msg. Do not edit."""
import sys
...
class image_obj_tracked(genpy.Message):
  ...
  _type = "autoware_msgs/image_obj_tracked"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','uint8','int32[]','autoware_msgs/image_rect_ranged[]','int32[]','int32[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = autoware_msgs.msg.image_rect_ranged()
        _v2 = val1.rect
        _x = _v2
        start = end
        end += 20
